    ...
    <>
      ...
      <div className="Page">
        ...
        <div className="text-description">
          <p>
            {/* <strong> */}
            Esse é o texto da descrição. Lorem ipsum dolor sit amet, consectetur
        ...
        <div className="text-content">
          <p>
            Esse é o texto da ação em si. On the other hand, we denounce with
            ...
            endures pains to avoid worse pains. On the other hand, we denounce
