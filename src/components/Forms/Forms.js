            ...
            <div className="search">
              ...
              <div className="search__page-form">
                ...
                <Form.Group className="search__form-control form-control-lg"  >
                  <Form.File id="exampleFormControlFile1" label="Upload de arquivo" />
                </Form.Group>
                </Col>
                    ...
                    <Col>
                    <Form.Group className="search__form-control form-control-lg" controlId="exampleForm.ControlTextarea1">
